...
"""Verify that starting privcyd with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start privcyd with -h for help text")
        ...
        self.log.info("Start privcyd with -version for version information")
