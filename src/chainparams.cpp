...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 90; // PRiVCY: 1 minute
        consensus.nPowTargetSpacing = consensus.nPowTargetTimespan; // PRiVCY: 1 minute
      ...
      /*  // just for now
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x000002d4548cc5c708d1405728600c2920c4d37d7eb7731ab8f82dd7c6607486"));
