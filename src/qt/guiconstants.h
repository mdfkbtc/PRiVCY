...
/* PRiVCYGUI -- Size of icons in status bar */
static const int STATUSBAR_ICONSIZE = 18;

/* PRiVCYGUI -- Size of button icons e.g. in SendCoinEntry or SignVerifyMessageDialog */
...
#define QAPP_ORG_NAME "PRiVCY"
#define QAPP_ORG_DOMAIN "privcy.org"
#define QAPP_APP_NAME_DEFAULT "PRiVCY-Qt"
#define QAPP_APP_NAME_TESTNET "PRiVCY-Qt-testnet"
#define QAPP_APP_NAME_DEVNET "PRiVCY-Qt-%s"
#define QAPP_APP_NAME_REGTEST "PRiVCY-Qt-regtest"
