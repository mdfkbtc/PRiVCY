...
/** Utility functions used by the PRiVCY Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "privcy:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load privcy specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a privcy specific theme is activated (light/dark).*/
