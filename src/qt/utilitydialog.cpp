    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        setWindowTitle(tr("PRiVCYSend information"));

        ui->aboutMessage->setTextFormat(Qt::RichText);
        ui->scrollArea->setVerticalScrollBarPolicy(Qt::ScrollBarAsNeeded);
        ui->aboutMessage->setText(tr("\
<h3>PRiVCYSend Basics</h3> \
PRiVCYSend gives you true financial privacy by obscuring the origins of your funds. \
All the PRiVCY in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
PRiVCYSend uses an innovative process to mix your inputs with the inputs of two or more other people, without having your coins ever leave your wallet. \
You retain control of your money at all times.<hr> \
<b>The PRiVCYSend process works like this:</b>\
<ol type=\"1\"> \
<li>PRiVCYSend begins by breaking your transaction inputs down into standard denominations. \
These denominations are 0.001 PRIV, 0.01 PRIV, 0.1 PRIV, 1 PRIV and 10 PRIV -- sort of like the paper money you use every day.</li> \
...
Each time the process is completed, it's called a \"round.\" Each round of PRiVCYSend makes it exponentially more difficult to determine where your funds originated.</li> \
...
Consequently, users who have backups disabled will also have PRiVCYSend disabled. <hr>\
For more information, see the <a style=\"%1\" href=\"https://docs.privcy.org/en/stable/wallets/privcycore/privcysend-instantsend.html\">PRiVCYSend documentation</a>."
