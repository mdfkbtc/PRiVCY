...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner PRiVCY address\n"
            "  payee          - Print the masternode payout PRiVCY address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the masternode operator public key\n"
            "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the masternode voting PRiVCY address\n"
        );
}
...
void masternode_count_help()
{
    throw std::runtime_error(
            ...
            "  ps            - number of PRiVCYSend compatible masternodes"
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    { "privcy",               "masternode",             &masternode,             {} },
    { "privcy",               "masternodelist",         &masternodelist,         {} },
};
