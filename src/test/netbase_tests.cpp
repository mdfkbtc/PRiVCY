...
// Copyright (c) 2014-2017 The PRiVCY Core developers
...
BOOST_AUTO_TEST_CASE(netbase_splithost)
{
    ...
    BOOST_CHECK(TestSplitHost("127.0.0.1:40400", "127.0.0.1", 40400));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:40400", "127.0.0.1", 40400));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:40400", "::ffff:127.0.0.1", 40400));
    BOOST_CHECK(TestSplitHost("[::]:40400", "::", 40400));
    BOOST_CHECK(TestSplitHost("::40400", "::40400", -1));
    BOOST_CHECK(TestSplitHost(":40400", "", 40400));
    BOOST_CHECK(TestSplitHost("[]:40400", "", 40400));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:40400", "127.0.0.1:40400"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:40400", "[::]:40400"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
