Contributing to PRiVCY Core
============================

The PRiVCY Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/privcypay/privcy/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the PRiVCY Core project (and related
projects such as libsecp256k1), and is not to be confused with overall PRiVCY
Network Protocol consensus changes.

Whether a pull request is merged into PRiVCY Core rests with the project merge
...
Patches that change PRiVCY consensus rules are considerably more involved than
...
Where a patch set proposes to change the PRiVCY consensus, it must have been
...
The review process is normally fairly responsive on the PRiVCY Core repository, however
...
The project leader is the release manager for each PRiVCY Core release.
