...
This document provides guidelines for internationalization of the PRiVCY Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `privcy_en.ts` remains unchanged.
