...
* privcy.conf: contains configuration settings for privcyd or privcy-qt
* privcyd.pid: stores the process id of privcyd while running
...
* debug.log: contains debug information and general logging generated by privcyd or privcy-qt
