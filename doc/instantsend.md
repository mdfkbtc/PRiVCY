...
This mechanism has been integrated into Bitcore-Node-PRiVCY which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/privcypay/insight-api-privcy#web-socket-api](https://github.com/privcypay/insight-api-privcy#web-socket-api)
* API: [https://github.com/privcypay/insight-api-privcy#instantsend-transactions](https://github.com/privcypay/insight-api-privcy#instantsend-transactions)
